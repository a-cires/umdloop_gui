...
Data originates on the Orin and is forwarded to CC2 (transport TBD).
...
async def _radio_ingestion_loop():
    """Simulate spectrum data ingestion for development.

    TODO: Replace with real transport from Orin once defined.
    """
    while True:
